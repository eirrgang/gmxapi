...
#
# This file is configured by CMake using the following CMake variables:
#    gmx_pygmx: path to Gromacs Python module at documentation build time
#    GMX_API_MAJOR: (integer) module major version number
#    GMX_API_MINOR: (integer) module minor version number
#    GMX_API_RELEASE: The full version, including alpha/beta/rc tags
#
...
project = u'Gromacs API'
copyright = u'2017, M. Eric Irrgang and Peter Kasson'
author = u'M. Eric Irrgang and Peter Kasson'
...
try:
    release = str(get_distribution('gmx').version)
...
# Gromacs currently uses 'classic'
#html_theme = 'classic'
...
#latex_documents = [
#    (master_doc, 'gmx.tex', u'gmx Documentation',
#     u'M. Eric Irrgang and Peter Kasson', 'manual'),
#]
...
#man_pages = [
#    (master_doc, 'gmxapi', u'gmxapi Documentation',
#     [author], 1)
#]
