...
Elements are deserialized into dependency graph (DAG) of operation builders.
...
The ``gmxapi`` Python package implements *gmxapi* operations in the ``gmxapi.operaiont.Context``
...
It will be migrated to :module:`gmxapi._workspec_0_2`.
